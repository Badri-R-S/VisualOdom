...
imgL1=cv2.imread("dataset/sequences/02/image_0/000000.png")
imgR1=cv2.imread("dataset/sequences/02/image_1/000000.png")
imgL2=cv2.imread("dataset/sequences/02/image_0/000001.png")
imgR2=cv2.imread("dataset/sequences/02/image_1/000001.png")
k1,d1=ORB(imgL1)
k2,d2=ORB(imgL2)
print(type(d2))
